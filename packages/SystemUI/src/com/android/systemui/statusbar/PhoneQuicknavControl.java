 ...
 */
public class PhoneQuicknavControl implements PieMenu.PieController, OnClickListener,
        OnLongClickListener {
    ...
    public PhoneQuicknavControl(Context context) {
        mContext = context;
    ...
    protected void populateMenu() {
        ...
        setClickListener(this, mBack, mHome, mRecent, mMenu, mScreenshot);

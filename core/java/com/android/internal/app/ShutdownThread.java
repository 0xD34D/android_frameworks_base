...
public final class ShutdownThread extends Thread {
        ...
        if (confirm) {
            ...
            if (mReboot) {
                dialog = new AlertDialog.Builder(context)
                        ...
                        .setSingleChoiceItems(R.array.shutdown_reboot_options, 0, new DialogInterface.OnClickListener() {
    ...
    private static void beginShutdownSequence(Context context) {
        ...
        if (mReboot) {
            pd.setTitle(context.getText(R.string.reboot_system));
            pd.setMessage(context.getText(R.string.reboot_progress));
        } else {
